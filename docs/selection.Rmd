...
* [SelectionHandle](#SelectionHandle)
    * [new SelectionHandle([group], [extraInfo])](#new_SelectionHandle_new)
    * _instance_
...
### new SelectionHandle([group], [extraInfo])

| Param | Type | Default | Description |
| ------------- | ------------- | ------------- | ------------- |
| [group] | <code>string</code> | <code>null</code> | The name of the Crosstalk group, or if none,   null or undefined (or any other falsy value). This can be changed later   via the [SelectionHandle#setGroup](#setGroup) method. |
| [extraInfo] | <code>Object</code> | <code></code> | An object whose properties will be copied to   the event object whenever an event is emitted. |
...
**Kind**: instance property of <code>[SelectionHandle](#SelectionHandle)</code>  
...
**Kind**: instance method of <code>[SelectionHandle](#SelectionHandle)</code>  
...
**Kind**: instance method of <code>[SelectionHandle](#SelectionHandle)</code>  
**Emits**: <code>[change](#SelectionHandle+event_change)</code>  
...
| listener | <code>[listener](#SelectionHandle..listener)</code> | The callback function that   will be invoked when the event occurs. |
...
| listener | <code>string</code> &#124; <code>[listener](#SelectionHandle..listener)</code> | Either the callback   function previously passed into [on](#SelectionHandle+on), or the   string that was returned from [on](#SelectionHandle+on). |
...
### "change"
**Kind**: event emitted by <code>[SelectionHandle](#SelectionHandle)</code>  
**Properties**
...
| sender | <code>[SelectionHandle](#SelectionHandle)</code> | The `SelectionHandle` instance that   changed the value. |

<a name="SelectionHandle..listener"></a>

### SelectionHandle~listener : <code>function</code>
**Kind**: inner typedef of <code>[SelectionHandle](#SelectionHandle)</code>  
